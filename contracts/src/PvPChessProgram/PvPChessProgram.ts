...
export const PvPChessProgramMethods = {
  // verify both players aggreed to start the game by verifying
  // their signatures
  start: {
    privateInputs: [Signature, Signature] as any,
    async method(
      state: RollupState,
  ...
  move: {
    privateInputs: [SelfProof, Move, PrivateKey] as any,
    async method(
      state: RollupState,
      earlierProof: SelfProof<RollupState, GameState>,
      move: Move,
  ...
  offerDraw: {
    privateInputs: [SelfProof, PrivateKey] as any,
    async method(
      state: RollupState,
      earlierProof: SelfProof<RollupState, GameState>,
      playerPrivateKey: PrivateKey
  ...
  resolveDraw: {
    privateInputs: [SelfProof, Bool, PrivateKey] as any,
    async method(
      state: RollupState,
      earlierProof: SelfProof<RollupState, GameState>,
      accept: Bool,
...
export const PvPChessProgram = ZkProgram({
  ...
  methods: PvPChessProgramMethods,
});
